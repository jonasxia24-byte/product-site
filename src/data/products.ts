...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "很多刚学缠论的朋友，总有一个痛点。市面上解读缠论的资料千千万，但是哪里有整理好的完整版禅师的资料呢？大家都知道，禅师在天涯论坛上的原贴可是不仅仅只讲了缠论技术的，还有很多对于文学、历史、经济的深度点评。而这些看似和缠论无关的文章，其实蕴含着更多交易的哲学。\n\n学缠十年，猫哥读了百万字级别的资料，最终，只有这两套资料是排版最好，内容最详实完整的，对我帮助很大，也在此算一个捷径分享给大家，省去诸位到网上搜索整理的时间。\n\n包含两份文件：\n缠中说禅文集大全（共1499页）汇集了所有禅师写过的文章（包括喜数女时期）\n市场哲学的数学原理（上下两册，共707页）含大量精美配图，方便快速理解缠论基础概念",
    price: 19.9,
