...
export const products: Product[] = [
  // 🧰 工具包/入门
  {
    id: "product-10",
    name: "原缠基础资料包（PDF）",
    subtitle: "原汁原味的禅师整理合集",
    description: "很多刚学缠论的朋友，总有一个痛点。市面上解读缠论的资料千千万，但是哪里有整理好的完整版禅师的资料呢？大家都知道，禅师在天涯论坛上的原贴可是不仅仅只讲了缠论技术的，还有很多对于文学、历史、经济的深度点评。而这些看似和缠论无关的文章，其实蕴含着更多交易的哲学。\n\n学缠十年，猫哥读了百万字级别的资料，最终，只有这两套资料是排版最好，内容最详实完整的，对我帮助很大，也在此算一个捷径分享给大家，省去诸位到网上搜索整理的时间。\n\n包含两份文件：\n\n缠中说禅文集大全（共1499页）汇集了所有禅师写过的文章（包括喜数女时期）\n\n市场哲学的数学原理（上下册，共707页）含大量精美配图，方便快速理解缠论基础概念",
    price: 19.9,
    image: "/products/基础资料包.jpg",
    tag: "新手必备",
    category: "其他",
  },
  ...
  // 🗣 咨询服务
  {
    id: "product-09",
    name: "1V1猫哥咨询服务",
    subtitle: "和猫哥直接对话，高效解决你的交易问题",
    description: "不是一场教你「买什么股票」的咨询，而是一次交易认知的重构。\n\n针对长期亏损、沉迷技术细节、缠论学习遇到瓶颈、无法建立交易系统的投资者，猫哥将结合近十年市场实践经验，帮助你重新理解市场本质，建立概率思维、风险管理和系统化交易框架。\n\n咨询内容包括：交易认知诊断、缠论学习方向梳理、交易系统构建思路、投资理念交流等。\n\n不提供个股推荐，不承诺收益，只帮助你找到长期独立交易的正确路径。\n\n注意：咨询时间灵活，和猫哥提前预约，并在正式咨询之前提交你在60分钟内想要主要解决的问题。\n\n详情请阅读：https://mp.weixin.qq.com/s/Z0CwxmFsLHSeC3THtzFT8A",
    price: 499,
    image: "/products/咨询.jpg",
    tag: "重点推荐",
    category: "其他",
  },
